                ...
                <div className = "card p-2">          
                    <div className="card-body">
                        <div className="form-group">
                            <input placeholder="名称:" type="text" className="mb-1 form-control input-sm col-md-5" name="name" value={this.state.name} onChange={this.handleInput} />
                            ...
                            <input placeholder="上课时间:" type="time" className="mb-1 form-control col-md-5" name="starttime" value={this.state.starttime} onChange={this.handleInput} />
                            {this.state.length}
                            ...
                            <input placeholder="开始日期:" type="date" className="mb-1 form-control col-md-5" name="startdate" value={this.state.startdate} onChange={this.handleInput} />
                            <input placeholder="结束日期:" type="date" className="mb-1 form-control col-md-5" name="enddate" value={this.state.enddate} onChange={this.handleInput} />
                            <input placeholder="老师:" type="text" className="mb-1 form-control col-md-5" name="teacher" value={this.state.teacher} onChange={this.handleInput} />
                            <input placeholder="地点:" type="text" className="mb-1 form-control col-md-5" name="location" value={this.state.location} onChange={this.handleInput} />
                            <label className="form-check-label">类型</label>
                            <CardTypeSelection className="mb-1 col-md-5" types={this.state.types} emitTypeId={this.updateCardType}></CardTypeSelection>
                        </div>
                    <button type="button" className="btn btn-outline-success col-md-5 mr-1" onClick={this.addCourse}>提交</button>
                    </div>
                </div>
                <div className="d-flex flex-row">
                    {this.state.courses.map((course,key) =>
                        <div className="m-1" key={key}><CourseItem course={course}></CourseItem></div>
                    )}
                </div>  
            </div>
        );
